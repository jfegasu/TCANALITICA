CREATE  table bendito.countries (
  country_id char(2) NOT NULL,
  country_name varchar(40) DEFAULT NULL,
  region_id integer  NOT NULL,
  PRIMARY KEY (country_id)
) ;
INSERT INTO bendito.countries (country_id, country_name, region_id) VALUES
('AR', 'Argentina', 2),
('AU', 'Australia', 3),
('BE', 'Belgium', 1),
('BR', 'Brazil', 2),
...
CREATE TABLE  bendito.departments (
...
INSERT INTO bendito.departments (department_id, department_name, manager_id, location_id) VALUES
...
CREATE TABLE  bendito.employees (
...
INSERT INTO bendito.employees (employee_id, first_name, last_name, email, phone_number, hire_date, job_id, salary, commission_pct, manager_id, department_id) VALUES
...
CREATE TABLE bendito.emp_details_view (
employee_id integer NOT NULL,
job_id VARCHAR(10) NOT NULL ,
...
INSERT INTO bendito.jobs (job_id, job_title, min_salary, max_salary) VALUES
...
CREATE TABLE bendito.job_history (
  employee_id integer NOT NULL,
...
INSERT INTO bendito.job_history (employee_id, start_date, end_date, job_id, department_id) VALUES
...
CREATE TABLE bendito.locations (
...
INSERT INTO bendito.locations (location_id, street_address, postal_code, city, state_province, country_id) VALUES
...
CREATE TABLE  bendito.regions (
  region_id integer NOT NULL,
  region_name varchar(25) DEFAULT NULL,
  PRIMARY KEY (region_id)
);

INSERT INTO bendito.regions (region_id, region_name) VALUES
(1, 'Europe'),
(2, 'Americas'),
(3, 'Asia'),
